...
describe ShowsController do
  ...
  let(:valid_attributes) { { "date" => "2014-01-06" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested show" do
        ...
        Show.any_instance.should_receive(:update).with({ "date" => "2014-01-06" })
        put :update, {:id => show.to_param, :show => { "date" => "2014-01-06" }}, valid_session
      end
